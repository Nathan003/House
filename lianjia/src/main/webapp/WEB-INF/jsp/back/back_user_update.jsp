...
<html lang="zh-CN"><head>
    ...
    <script src="<%=request.getContextPath() %>/resources/lib/jquery-1.11.1.min.js" type="text/javascript"></script>

    

    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/resources/stylesheets/theme.css">
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/resources/stylesheets/premium.css">
  ...
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <sf:form method="post" modelAttribute="user">
        ...
        <label>用户姓名</label>
        <sf:input path="userName" value="${userName }" class="form-control"/>
        </div>
        <div class="form-group">
        <label>用户密码</label>
        ...
        <div class="form-group">
        <label>用户性别</label>
         <sf:input path="userGender" value="${userGender }" class="form-control"/>
        </div>
        <div class="form-group">
        <label>用户电话</label>
        <sf:input path="userPhone" value="${userPhone }" class="form-control"/>
        </div>
		
        <div class="form-group">
          <label>用户地址</label>
           <sf:input path="userAddress" value="${userAddress }" class="form-control"/>
        </div>
