	...
	<div class="content">
		...
		<!-- 	<div class="btn-toolbar list-toolbar">
			...
			<table class="table">
				...
				<tbody>
				<c:forEach items="${traRecordsList }" var="records" varStatus="status"
			begin="${pageSize*(curPage-1) }" end="${pageSize*curPage-1 }">
					<tr>
						...
						<td> <a
							href="javascript:deleteHouse('${records.recordId }')" role="button" ><i
			...
			<ul class="pagination">
				<li><a href="<%=request.getContextPath() %>/admin/traRecordsList?curPage=1">&laquo;</a></li>
				<li><a href="<%=request.getContextPath() %>/admin/traRecordsList?curPage=1">1</a></li>
				<li><a href="<%=request.getContextPath() %>/admin/traRecordsList?curPage=2">2</a></li>
				<li><a href="<%=request.getContextPath() %>/admin/traRecordsList?curPage=3">3</a></li>
				<li><a href="<%=request.getContextPath() %>/admin/traRecordsList?curPage=${totalPage }">&raquo;</a></li>
			</ul>
